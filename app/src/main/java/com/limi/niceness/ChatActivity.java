...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String customFont = "lalo_light.ttf";
        Typeface typeface = Typeface.createFromAsset(getAssets(), "lalo_light.ttf");
        ...
        recyclerView.addOnItemTouchListener(new Recycler(getApplicationContext(), recyclerView, new ClickListener() {
            @Override
